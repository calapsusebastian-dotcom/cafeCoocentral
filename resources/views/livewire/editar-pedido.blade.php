<x-slot:headerActions>
    <a href="{{ route('pedidos.imprimir', $pedido) }}" target="_blank" class="hidden md:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-gray-200 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors">
        <x-heroicon-o-printer class="w-4 h-4" />
        Imprimir
    </a>
    <a href="{{ route('pedidos.index') }}" class="hidden md:inline-flex items-center px-3 py-2 rounded-xl border border-gray-200 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors">
        Cancelar
    </a>
            ...
            <section class="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                    ...
                    <label class="block">
                        ...
                        <select wire:model="status" class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-200">
                            <option value="pendiente">Pendiente</option>
                ...
                <div class="mt-4">
                    <label class="block">
                        ...
                        <input type="text" wire:model="numero_guia" placeholder="Ej. 1234567890" class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-200" />
                    </label>
                </div>
            </section>
        ...
        <div class="xl:col-span-1">
            <div class="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-6 xl:sticky xl:top-28">
                ...
                >
                    ...
                    <span wire:loading.remove wire:target="guardarPedido">Guardar cambios</span>
